...
export declare type DefaultSpanDef = {
    ...
    /**
     * If the user wants to show more text in title then he or she can configure no of lines to be shown in title(Maximum allowed 3 lines).
     */
    minimumTitleRow?: number;
    /**
     * If the user wants to show more text in title then he or she can configure no of lines to be shown in sub-title(Maximum allowed 2 lines).
     */
...
export interface CustomCard {
     ...
     * @TJS-pattern ^(?!(sap.ovp.cards.charts.analytical|sap.ovp.cards.linklist|sap.ovp.cards.list|sap.ovp.cards.stack|sap.ovp.cards.table)$).*$
     */
    template: string;
    /**
...
export interface ListCard {
     ...
     */
    template: CardTemplateType.list;
    /**
...
export interface TableCard {
     ...
     */
    template: CardTemplateType.table;
    /**
...
export interface AnalyticalCard {
     ...
     */
    template: CardTemplateType.analytical;
    /**

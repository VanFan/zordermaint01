...
export interface MetadataInstanceInterface {
    createInstance(pageType: PageType, schemaPropertyName: string, data?: object, controlPropertyValue?: string): any;
    createPageInstance(pageType: PageType, data?: object): object;
}
export declare abstract class MetadataFactory implements MetadataInstanceInterface {
     ...
     */
    protected constructor(controls: V2Controls, pages: V2Pages, pageTypes: object);
    /**

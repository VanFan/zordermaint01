...
function generateAnalyticalListReportSchemaV2(generateParameters, genericSchema, entityTypeName) {
    ...
    if (!entityType) {
        ...
        const pageKeys = [];
        const v2Page = import_1.findAnalyticalListPage(generateParameters.manifest[v2_1.ManifestSection.generic].pages, pageKeys);
        if (!v2Page) {
            extensionLogger_1.log(generateParameters.logger, {
                severity: "error" /* Error */,
        ...
        listReport_1.addEnumForVariantPaths(entityType, appSchema, generateParameters.serviceAVT);

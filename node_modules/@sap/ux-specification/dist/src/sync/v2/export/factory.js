...
const OVPElements = {
    [v2_1.CardSettingsType.listCardSettings]: controls.ListCard,
    [v2_1.CardSettingsType.analyticalCardSettings]: controls.AnalyticalCard,
    [v2_1.CardSettingsType.stackCardSettings]: controls.StackCard,
    [v2_1.CardSettingsType.linkListCardSettings]: controls.LinklistCard,
    [v2_1.CardSettingsType.tableCardSettings]: controls.TableCard
};
const OPElements = {
    [common_1.SAPUI5_VIEW_CLASS]: controls.ObjectPageCustomSectionView,
    [common_1.SAPUI5_FRAGMENT_CLASS]: controls.ObjectPageCustomSectionFragment,
...
const pageTypes = {
    ...
    [common_1.PageType.OverviewPage]: OVPElements
};
/**

...
function addSettings(importParameters, listReportConfig, factory, pageKey) {
    ...
    if (tableType) {
        ...
        localJsonSchema = importParameters.jsonSchema['definitions'][types_1.RESPONSIVETABLE];
    }
    ...
    index_1.transferSettingsOfObject(listReportConfig.filterBar, importParameters.manifest, importParameters.jsonSchema['definitions']['FilterBar'], pageKey, importParameters.logger);
}
/**

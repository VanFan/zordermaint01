...
function addSmartFilterBarFlex(config, changePropertyKey, change, jsonSchema) {
    var _a, _b, _c, _d;
    const schemaProperty = ((_b = (_a = jsonSchema['definitions']) === null || _a === void 0 ? void 0 : _a['FilterBar']) === null || _b === void 0 ? void 0 : _b.properties[changePropertyKey]) || ((_d = (_c = jsonSchema['definitions']) === null || _c === void 0 ? void 0 : _c['AnalyticalListPageFilterBar']) === null || _d === void 0 ? void 0 : _d.properties[changePropertyKey]);
    if (schemaProperty) {
...
function addAdditionalFlexChanges(config, change, jsonSchema) {
    ...
    if ((!config.table.type || config.table.type === v2_1.TableTypeV2.ResponsiveTable) &&
        ...
        constructorName = 'ResponsiveTable';
    }
    else {
